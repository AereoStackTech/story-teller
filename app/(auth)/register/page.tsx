...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-slate-950 relative overflow-hidden">
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-purple-600/20 rounded-full blur-3xl -z-10" />
      ...
      <div className="w-full max-w-md space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-slate-400">Join over 120,000 authors and creative studios</p>
        </div>

        <Card className="border-white/10 bg-slate-900/80">
          <CardHeader>
            <CardTitle className="text-xl text-center">Create Creator Account</CardTitle>
            <CardDescription className="text-center">Start your 14-day free trial with 250 AI credits.</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <Input
                  type="email"
                  placeholder="elena@narrative.io"
                  value={email}
